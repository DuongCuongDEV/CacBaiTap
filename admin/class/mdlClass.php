        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <div class="form-floating py-2">
                    <select required="true" class="form-control" placeholder="Leave a comment here" id="nienKhoa">
                        <option value="">Nhập khóa tương ứng</option>
                    </select>
                    <label for="maMon">Niên khóa:</label>
                </div>
                <div class="form-floating py-2">
                    <textarea class="form-control" placeholder="Leave a comment here" id="txtFullname"></textarea>
                    <label for="txtFullname">Họ và tên:</label>
                </div>
                <div class="form-floating py-2">
                    <textarea class="form-control" placeholder="Leave a comment here" id="txtAcc"></textarea>
                    <label for="txtAcc">Tài khoản:</label>
                </div>
                <div class="form-floating py-2">
                    <textarea class="form-control" placeholder="Leave a comment here" id="txtPass"></textarea>
                    <label for="txtPass">Đáp án B:</label>
                </div>
                <div class="form-floating py-2">
