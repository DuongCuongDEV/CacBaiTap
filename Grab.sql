...
CREATE TABLE `uu_dai` (
  ...
  `anh_uu_dai` varchar(225) NOT NULL,
    `chi_tiet_uu_dai` varchar(225) NOT NULL,
...
select ma_nguoi_dung, email from thong_tin_nguoi_dung order by ma_nguoi_dung desc limit 1;
...
INSERT INTO `uu_dai` (`ma_uu_dai`, `ten_uu_dai`,`anh_uu_dai`,`chi_tiet_uu_dai`, `so_tien_giam`) VALUES
('MGG1', 'Uu dai voucher 5000','anhUuDai1.png','Mới tải app bạn được giảm 5000VND', 5000),
('MGG2', 'Uu dai voucher 10000','anhUuDai2.png','Hôm nay muồng 1 âm được giảm 10000VND', 10000),
('MGG3', 'Uu dai voucher 15000','anhUuDai3.png','Hôm nay đẹp trời được giảm 15000VND', 15000);
...
select * from thong_tin_tai_khoan;
